...
let LIMIT: any;
let COMMA: any;
let RESERVED_SELECT: any;
let ASTERISK: any;
let RESERVED_CLAUSE: any;
let RESERVED_SET_OPERATION: any;
let ARRAY_IDENTIFIER: any;
let ARRAY_KEYWORD: any;
let RESERVED_FUNCTION_NAME: any;
let DOT: any;
let BETWEEN: any;
let AND: any;
let CASE: any;
...
let OPERATOR: any;
let IDENTIFIER: any;
let QUOTED_IDENTIFIER: any;
let VARIABLE: any;
let NAMED_PARAMETER: any;
let QUOTED_PARAMETER: any;
let NUMBERED_PARAMETER: any;
let POSITIONAL_PARAMETER: any;
let CUSTOM_PARAMETER: any;
let NUMBER: any;
let STRING: any;
let RESERVED_KEYWORD: any;
let RESERVED_PHRASE: any;
let RESERVED_JOIN: any;
let RESERVED_DATA_TYPE: any;
let RESERVED_PARAMETERIZED_DATA_TYPE: any;
let OR: any;
let XOR: any;
