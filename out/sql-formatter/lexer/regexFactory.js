 ...
 * @param lineCommentTypes - list of character strings that denote line comments
 */
 ...
 * @param paramTypes - list of strings that denote placeholder types
 * @param pattern - string that denotes placeholder pattern
 */
...
const identifierPattern = ({ first, rest, dashes, allowFirstCharNumber, } = {}) => {
    ...
    const firstChars = (0, regexUtil_js_1.escapeRegExp)(first ?? '');
    const restChars = (0, regexUtil_js_1.escapeRegExp)(rest ?? '');
