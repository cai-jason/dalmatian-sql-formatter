...
let ASTERISK;
let RESERVED_CLAUSE;
let RESERVED_SET_OPERATION;
let ARRAY_IDENTIFIER;
let ARRAY_KEYWORD;
let RESERVED_FUNCTION_NAME;
let DOT;
let BETWEEN;
let AND;
let CASE;
...
let VARIABLE;
let NAMED_PARAMETER;
let QUOTED_PARAMETER;
let NUMBERED_PARAMETER;
let POSITIONAL_PARAMETER;
let CUSTOM_PARAMETER;
let NUMBER;
let STRING;
let RESERVED_KEYWORD;
let RESERVED_PHRASE;
let RESERVED_JOIN;
let RESERVED_DATA_TYPE;
let RESERVED_PARAMETERIZED_DATA_TYPE;
let OR;
let XOR;
let LINE_COMMENT;
let BLOCK_COMMENT;
